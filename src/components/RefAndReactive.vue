<template>
  <div class="my-4">
    <h3 class="font-semibold">Ref and Reactive</h3>
    <hr class="mb-2" />
    <div>
    ...
    <div>
      <div
        class="bg-gray-800 rounded-lg text-white py-2 px-3 mr-2 inline-block mt-2 w-36"
      >
    ...
    <h1 class="mt-3">components/RefAndReactive.vue</h1>
    <div v-highlight>
